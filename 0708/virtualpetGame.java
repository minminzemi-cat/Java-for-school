...
void sleep(){
    System.out.println(this.name + ":よく寝た");
...
void walk(){
    if(this.energy < 10){
        System.out.println(this.name + "疲れちゃって、これ以上歩けない");

    }else{
        System.out.println("歩いたよ。体力が10減った。最大体力が1増えた");
        this.energy -=10;
        this.maxEnergy += 1;
    }
}
...
public class virtualpetGame {
    ...
    VirtualDog jiro = new VirtualDog("ジロ", 100, 40);
